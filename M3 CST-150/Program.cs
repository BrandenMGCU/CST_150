        ...
        public class InventoryShoppingList
        {
            public static void Main()
            {
                ...
                if (option == "yes" || option == "Yes")
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine("Would you like to search for an item?");
                    string usersearch = Console.ReadLine();
                    Console.WriteLine();
                    if (usersearch == "yes" || usersearch == "Yes")
                    {
                        Search();
                    }

                    // If no then the current list will be displayed.
                    if (usersearch == "no" || usersearch == "No")
                    {
                        foreach (Inventory i in shoppingItems)
                        {
                            Console.WriteLine("   " + i);
